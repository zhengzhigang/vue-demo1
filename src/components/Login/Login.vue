<template>
    <div class="login" :class="method">
        <h1>更美医生后台</h1>
        <button @click="goToAbout">Go About Page</button>
        <form>
            ...
            <div>
                <router-link :to="{name: 'login1', params: {userid: '我是传世的参数'}}">显示Login1</router-link> | 
                <router-link to="/login2/11/我是title">显示Login2</router-link> | 
                <router-link to="/login3">显示Login3</router-link>
                <transition name="fade">
                    <router-view></router-view>
                </transition>
                <router-view name="login2"></router-view>
                <router-view name="login3"></router-view>
            </div>
        </form>
    </div>
</template>
